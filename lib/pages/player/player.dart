...
import 'package:nieproject/widgets/left_side_menu.dart';
...
class _OnAirScreenState extends State<OnAirScreen> {
  ...
  String audioStreamUrl = playerOnlineIOS;
  ...
  MenuWindow _menuWindow = Get.find();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      initAndPlayAudio(audioStreamUrl); // Move your async call to here
    });
  }
                    ...
                    children: [
                      Row(
                        children: [
                          IconButton(
                            onPressed: () {
                              handleMenuOption("changeLanguage", context);
                            },
                            icon: ImageIcon(
                              AssetImage(getLanguageIconPath()),
                              color: Colors.white,
                              size:
                                  screenWidth / 15, // Adjust the size as needed
                            ),
                          ),
                          Expanded(
                              child: Center(
                      ...
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: AssetImage('assets/Comp 1_2.gif'),
                          backgroundColor:
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient:
                              audioController.isPlay ? onFire : onAutomation,
                          border: Border.all(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            //Get.to(() => _twoCirclePlayList);
                          },
                          child: Align(
                            alignment: Alignment.topCenter,
                            child:
                                Text(
                                    audioController.isPlay ? 'ON AIR' : 'AUTO',
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onPanUpdate: (details) async {
                            ...
                            await audioController.audioPlayer.setVolume(
                                double.parse(volume.toStringAsFixed(1)));
                          },
                          child: CustomPaint(
                        ...
                        children: [
                          Expanded(
                            child: IconButton(
                              ...
                              icon: SizedBox(
                                width:
                                    screenWidth * 0.1, // Adjust size as needed
                              ...
                              onPressed: () {
                                Fluttertoast.showToast(
                                  ...
                                  backgroundColor: Colors.black.withOpacity(
                                      0.8), // Background color of the toast
                                  textColor:
